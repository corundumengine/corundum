...
namespace corundum::world {
  ...
  namespace {
    ...
    [[nodiscard]] int pick_elevation_at(const corundum::world::MapView &map, int col, int row) noexcept {
  ...
  std::optional<TileCoord> pick_tile(float mouse_x, float mouse_y, const corundum::world::Camera &camera,
                                     const corundum::world::MapView &map, float elev_step, float zoom) noexcept {
